...
\begin{definition}
	\begin{mdframed} 
		Das Prämaß $\lambda^d_{\FF^d}$ heißt \textbf{$d$-dimensionales Lebesgue-Prämaß}.
	\end{mdframed}
\end{definition}
...
Wir geben für \emph{beliebige} Teilmengen von $X$ ein \textbf{äußeres $\mu$-Volumen} \ (bzw. eine \textbf{obere $\mu$-Volumenschranke}), indem wir \emph{abzählbare} Überdeckungen durch Teilmengen aus $\HH$ verwenden. Wir definieren für $M \subset X$
$$
