...
Seien $\mu_i$ Prämaße auf Ringen $\mathcal{R}_i \subset \mathcal{P}(X_i)$, $i=1,2$. Zu zeigen: Der Produktinhalt $\mu_1 \boxtimes \mu_2$ auf $\mathcal{R}_1 \boxtimes \mathcal{R}_2$ ist $\sigma$-additiv. Weil Figuren endliche disjunkte Vereinigungen von Quadern sind und der Inhalt $\mu_1 \boxtimes \mu_2$ (endlich) additiv ist, genügt es, abzählbare disjunkte Zerlegungen
$$
