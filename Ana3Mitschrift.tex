...
\begin{example}
Sei $X$ ein topologischer Raum versehen mit der Topologie $\TT$. Dann induziert $T$ die Borelsche $\sigma$-Algebra $\BB(X)=\sigma(\TT)$ und $f:X \longrightarrow \ol\R$ genau dann messbar, wenn $f$ als eine Abbildung Borel-messbar ist. Insbesondere sind stetige nummerische Funktionen messbar.
\end{example}
