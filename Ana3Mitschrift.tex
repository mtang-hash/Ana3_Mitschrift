...
\begin{satz}
\begin{mdframed}
Ist $\mu$ ein Prämaß auf $\RR$, so wird $\mu$ durch das assoziierte äußere Maß $\mu^*$ zu einem Maß $\mu^*|_{\sigma(\RR)}$ auf dem von Ring erzeugten $\sigma$-Algebra $\sigma(\RR)$ fortgesetzt.
\end{mdframed}
\begin{proof}
