...
$$
\end{mdframed}
Dieser Satz besagt also, dass die Volumenverzerrung von $\Phi$ durch den Faktor $|\det A|$ bestimmt ist, wobei $A$ der linearer Anteil von $\Phi$ ist.
\end{satz}
