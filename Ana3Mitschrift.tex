\input{settings.tex}
\title{\huge Analysis III   \\ \vspace{0.2pc} \Large Maßtheorie und Integralrechnung mehrerer Variablen}
%\date{}
\begin{document}
\maketitle
\tableofcontents
...
\appendix
\newpage
\section{Integrale stetiger Funktionen \normalsize (einer reellen Variable)}
...
$$
Also die \textbf{Substitutionsregel}
$$
\boxed{
...
\begin{example} \
\begin{enumerate}
 \item \textbf{lineare Substitution} $x = u+\alpha$ 
 \item 
\end{enumerate}
\end{example}
\end{document}
