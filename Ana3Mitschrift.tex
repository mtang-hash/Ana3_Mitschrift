...
\subsubsection{Integral allgemeiner numerischer Funktionen}
...
\end{array}.
\end{equation*}
und den Maßraum $(X,\AA,\mu)$. Für $A\in \AA$ wird das eingeschränkte Maß $\mu|_A:=\mu|_{\AA|_A}$ auf der Spur-$\sigma$-Algebra $\AA|_A$ induziert, ebenso der Unterraum $(A,\AA|_A,\mu|_A)$, also
