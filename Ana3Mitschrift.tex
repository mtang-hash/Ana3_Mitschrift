...
\begin{definition}
\begin{mdframed}
$M\subset X$ heißt \textbf{$\mu^*$-messbar}, falls 
\begin{equation*}
\mu^*(S)=\mu^*(S\cap M) + \mu^*(S\setminus M)
\end{equation*}
...
\begin{definition}
$N \subset X$ heißt \textbf{$\mu^*$-Nullmenge}, falls $\mu^*(N)=0$.
\end{definition}
...
\end{equation*}
Also überall Gleichheit, dies zeigt, dass $\ol{M}_\infty \in \AA^*$, d.h. $\AA^*$ eine $\sigma$-Algebra.
